...
# 5. Checkpointer
# -------------------
conn = sqlite3.connect(database="chatbot-tool.db", check_same_thread=False)
...
# res = chatbot.invoke({'messages':[HumanMessage(content='what is price of tesla')]},config={'configurable':{'thread_id':'thread-3'}})
